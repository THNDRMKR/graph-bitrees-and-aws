...
Graph::Graph(QWidget *parent) : QGraphicsView(parent){
    ...
    scene->setSceneRect(-500, -600, 1600, 1120);
...
void Graph::createTabWidget(const QRectF &rect){
    ...
    tab->addTab(edgeTab, tr("Редактирование"));
    tab->addTab(voyTab, tr("Коммивояжёр"));
    tab->addTab(graphTab, tr("Инфо"));
    ...
    addVertexButton->setStyleSheet("QPushButton:selected, QPushButton:hover{background-color: rgb(37,109,165); color: White;} "
    ...
    eraseVertexButton->setStyleSheet("QPushButton:selected, QPushButton:hover{background-color: rgb(37,109,165); color: White;} "
                                   "QPushButton:pressed{background-color: rgb(48,146,220);} "
                                   "QPushButton{height: 30px; width: 30px; background-color: lightBlue; border-right, border-bottom: 4px solid Gray;}");
    ...
    addEdgeButton->setStyleSheet("QPushButton:selected, QPushButton:hover{background-color: rgb(37,109,165); color: White;} "
                                 "QPushButton:pressed{background-color: rgb(48,146,220);} "
                                 "QPushButton{height: 30px; width: 30px; background-color: lightBlue; border-right, border-bottom: 4px solid Gray;}");
    ...
    updateWeightButton->setStyleSheet("QPushButton:selected, QPushButton:hover{background-color: rgb(37,109,165); color: White;} "
                                  "QPushButton:pressed{background-color: rgb(48,146,220);} "
                                  "QPushButton{height: 30px; width: 30px; background-color: lightBlue; border-right, border-bottom: 4px solid Gray;}");
    ...
    eraseEdgeButton->setStyleSheet("QPushButton:selected, QPushButton:hover{background-color: rgb(37,109,165); color: White;} "
                                 "QPushButton:pressed{background-color: rgb(48,146,220);} "
                                 "QPushButton{height: 30px; width: 30px; background-color: lightBlue; border-right, border-bottom: 4px solid Gray;}");
    connect(eraseEdgeButton, &QPushButton::clicked, this, &Graph::createEraseEdgeWindow);
    QPushButton *resetButton1 = new QPushButton();
    resetButton1->setText(tr("Очистить"));
    resetButton1->setFont(textfont);
    resetButton1->setMaximumSize(QSize(150, 50));
    resetButton1->setStyleSheet("QPushButton:selected, QPushButton:hover{background-color: rgb(37,109,165); color: White;} "
                             "QPushButton:pressed{background-color: rgb(48,146,220);} "
                             "QPushButton{height: 30px; width: 30px; background-color: lightBlue; border-right, border-bottom: 4px solid Gray;}");
    connect(resetButton1, &QPushButton::clicked, this, &Graph::clear);

    edgeTabLayout->addWidget(addVertexButton);
    edgeTabLayout->addWidget(eraseVertexButton);
    edgeTabLayout->addWidget(addEdgeButton);
    edgeTabLayout->addWidget(updateWeightButton);
    edgeTabLayout->addWidget(eraseEdgeButton);
    edgeTabLayout->addWidget(resetButton1);
    ...
    functionButton->setStyleSheet("QToolButton:selected, QToolButton:hover{background-color: rgb(37,109,165); color: White;} "
                             "QToolButton:pressed{background-color: rgb(48,146,220);} "
                             "QToolButton{height: 30px; width: 30px; background-color: lightBlue; border-right, border-bottom: 4px solid Gray;}");
    ...
    resetButton->setStyleSheet("QPushButton:selected, QPushButton:hover{background-color: rgb(37,109,165); color: White; color: White;} "
                             "QPushButton:pressed{background-color: rgb(48,146,220);} "
                             "QPushButton{height: 30px; width: 30px; background-color: lightBlue; border-right, border-bottom: 4px solid Gray;}");
    ...
    clearButton->setStyleSheet("QPushButton:selected, QPushButton:hover{background-color: rgb(37,109,165); color: White;} "
                             "QPushButton:pressed{background-color: rgb(48,146,220);} "
                             "QPushButton{height: 30px; width: 30px; background-color: lightBlue; border-right, border-bottom: 4px solid Gray;}");
    ...
    functionsInfoButton->setStyleSheet("QPushButton:selected, QPushButton:hover{background-color: rgb(37,109,165); color: White;} "
                             "QPushButton:pressed{background-color: rgb(48,146,220);} "
                             "QPushButton{height: 30px; width: 30px; background-color: lightBlue; border-right, border-bottom: 4px solid Gray;}");
    ...
    matrixInfoButton->setStyleSheet("QPushButton:selected, QPushButton:hover{background-color: rgb(37,109,165); color: White;} "
                             "QPushButton:pressed{background-color: rgb(48,146,220);} "
                             "QPushButton{height: 30px; width: 30px; background-color: lightBlue; border-right, border-bottom: 4px solid Gray;}");
    ...
    findShortPath->setStyleSheet("QPushButton:selected, QPushButton:hover{background-color: rgb(37,109,165); color: White;} "
                                 "QPushButton:pressed{background-color: rgb(48,146,220);} "
                                 "QPushButton{height: 30px; width: 30px; background-color: lightBlue; border-right, border-bottom: 4px solid Gray;}");
    ...
    clearLineButton->setStyleSheet("QPushButton:selected, QPushButton:hover{background-color: rgb(37,109,165); color: White;} "
                                 "QPushButton:pressed{background-color: rgb(48,146,220);} "
                                 "QPushButton{height: 30px; width: 30px; background-color: lightBlue; border-right, border-bottom: 4px solid Gray;}");
    ...
    resetButton2->setText(tr("Сбросить"));
    resetButton2->setFont(textfont);
    resetButton2->setMaximumSize(QSize(150, 50));
    resetButton2->setStyleSheet("QPushButton:selected, QPushButton:hover{background-color: rgb(37,109,165); color: White; color: White;} "
                             "QPushButton:pressed{background-color: rgb(48,146,220);} "
                             "QPushButton{height: 30px; width: 30px; background-color: lightBlue; border-right, border-bottom: 4px solid Gray;}");
    connect(resetButton2, &QPushButton::clicked, this, &Graph::reset);
    ...
    voyTabLayout->addWidget(resetButton2);
